...
@section('content')
    <div class="tableListing">
        ...
        <div class="portlet-body form">
            {!! Form::open(array('class' => 'form-horizontal', 'id' =>'updateAdminUser', 'method' => 'POST', 'url'=> '/admin/updateAdminUser/'.$userData['id'])) !!}
            {!! csrf_field() !!}
            <div class="tab-content">
                <div class="control-group">
                    {!! Form::label('firstname', 'Firstname', ['class' => 'control-label']) !!}
                    <div class="controls">
                        {!! Form::text('firstname',$userData->firstname, old('firstname') , ['class' => 'span6 m-wrap','id' => 'firstname','placeholder' => 'This field is required', 'autofocus', 'data-prompt-position'=> 'centerRight']) !!}
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {!! Form::text('lastname', $userData->lastname, old('lastname') , ['class' => 'span6 m-wrap','id' => 'lastname','placeholder' => 'This field is required', 'autofocus', 'data-prompt-position'=> 'centerRight']) !!}
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        {!! Form::text('email',$userData->email, old('email') , ['class' => 'span6 m-wrap','id' => 'email','placeholder' => 'This field is required', 'autofocus', 'data-prompt-position'=> 'centerRight']) !!}
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <label class="radio">
                            {!! Form::radio('status', 'Active',  ($userData->status == 'Active') ? 'checked="checked"' : '' ,['data-prompt-position' => 'centerRight','data-title'=>'Active']) !!}
                            Active
                        </label>
                        <div class="clearfix"></div>
                        <label class="radio">
                            {!! Form::radio('status', 'Inactive', ($userData->status == 'Inactive') ? 'checked="checked"' : '',['data-prompt-position' => 'centerRight','data-title'=>'Inactive']) !!}
                            Inactive
                        </label>
...
@section('script')
    <script type="text/javascript">
        $(function () {
            ...
            var validator = $('#updateAdminUser').validate({
                rules: {
                    firstname: {
                        required: true,
                        alphabetsOnly: true
